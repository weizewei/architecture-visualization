...
**Usage:** Ask for an architecture / flow / 链路图 in Agent chat. The agent traces real code, writes a `.canvas.tsx`, and renders a DAG—click a node to open its source file/line.

**Contents:** `SKILL.md` (instructions + triggers), `canvas-dag.md` (interactive DAG template).
